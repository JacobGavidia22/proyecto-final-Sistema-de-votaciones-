...
<body onload="retroceder();">
	<header>
		<div class="centra">
		    ...
		    <h1>Elecciones Alcaldes</h1><img class="ayuda" onClick ="alert('Dar un click en la bandera de su eleccion para poder votar')" src="../../image/ayuda.gif">
		</div>
	</header>
	...
	<section class="papeletap">
		...
		$consulta = "SELECT * FROM `inscripcioncandidato` WHERE TipoCandidatura like'%Alcalde%'";
