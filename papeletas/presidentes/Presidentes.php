...
<head>
	<title>Papeleta de votaciones presidenciales</title>
	<meta charset="utf-8">
...
<body onload="retroceder();">
	<header>
		<div class="centra">
		    ...
		    <h1>Elecciones Presidenciales </h1><img class="ayuda" onClick ="alert('Dar un click en la bandera de su eleccion para poder votar')" src="../../image/ayuda.gif">
		</div>
	</header>
	...
	<section class="papeletap">
		...
		$consulta = "SELECT idBandera, Bandera FROM banderapartidos";
		$resultado= @mysql_query($consulta) or die(mysql_error());
		while ($datos = @mysql_fetch_assoc($resultado) ){
			$ruta = "../../archivo/partidos/" . $datos['Bandera'];

			echo "<a href=".@$form."votos.php?idBandera=".$datos['idBandera']."><img class='presidente' src='$ruta' /></a>";
		}
		?>
