...
<head>
	<meta charset="utf-8">
	<title>Registros de Votantes</title>
...
<body>
	<div class="contenedor">
		<header>
			<div class="centra">
		        ...
		        <nav>
		        	<a href="../paginas/InVotantes.php">Inicio</a>
		        </nav>
			</div>
	    </header>
	</div>
	...
	<section>
		<p>Registro de los Votantes</p>
		<br>

		<?php

		$sql = 'SELECT * FROM registrovotantes';
		$datoss =  consultaD($con, $sql);
		print imprimetablav($datoss,"Votantes","table table-bordered table-striped","table",1);
		?>
	</section>
...
if($_GET("g")!=null){
    ...
    function redir3(){
         window.location='consultarvotante.php';   
